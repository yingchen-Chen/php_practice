...
// 做資料表的存取
$stmt=$pdo->query("SELECT * FROM address_book1 LIMIT 4"); //"SELECT*FROM address_book1"直接放你要加進來的資料名稱(SQL);使用$pdo->query就是給SQL指定一個代理人也就是PDOstatement;LIMIT 4代表最多拿出4筆資料，假設總共5萬多筆，寫了fetchALL會GG
